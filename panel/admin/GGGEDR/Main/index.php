...
$prefix = s;
try {
$sql = "SELECT * FROM `699965643360960542` WHERE id = prefix";
...
if($_COOKIE["user_id"] == null){
    ...
    if(base64_decode($_COOKIE["user_id"]) == "535708984959827978"){
        ?>
        <?php
        ...
        <div class="heading text-center" style="text-align: left !important;">
            ...
            <a style="color: orange">Prefix:   </a><input style="background-color: slategray; color: white; border-color: transparent;" id="prefix" type="text" spellcheck="false" name="prefix" value="<?php echo $prefix?>"><br/>
            <h1 class="display-5 title" style="text-align: left">MESSAGES:</h1><br/>
            <a style="color: orange">Vyber si kategóriu:</a><input style="background-color: slategray; color: white; border-color: transparent;" id="prefix" type="text" spellcheck="false" name="prefix" value="Select category:"><br/>
            <a style="color: orange">Kategórie:</a><input style="background-color: slategray; color: white; border-color: transparent;" id="prefix" type="text" spellcheck="false" name="prefix" value="Categories:"><br/>
            <a style="color: orange">Help menu ban:</a><input style="background-color: slategray; color: white; border-color: transparent;" id="prefix" type="text" spellcheck="false" name="prefix" value="Permanently bans a user"><br/>
            <br /><br /><br /><br /><br /><br />
        </div>
